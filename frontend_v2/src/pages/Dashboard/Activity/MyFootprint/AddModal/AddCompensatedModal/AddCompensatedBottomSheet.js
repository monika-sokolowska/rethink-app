...
const AddCompensatedBottomSheet = ({ isOpen, handleClose }) => {
    ...
    <div
      ...
      <div className={`${classes.bottomSheet} ${isOpen ? "open" : ""}`}>
        ...
        <div className={classes.header}>
          <h2 className={classes.title}>Add Compensated Footprint</h2>
        ...
        <form onSubmit={onSubmit}>
          <div className={classes.content}>
            <div className={classes.inputContainer}>
              <label htmlFor="compensated-name" className={classes.label}>
                Description
              </label>
              <input
                id="compensated-name"
            ...
            <div className={classes.inputContainer}>
              <label htmlFor="compensated-footprint" className={classes.label}>
                Footprint
              </label>
              <input
                id="compensated-footprint"
                type="number"
                name="footprint"
...
export default AddCompensatedBottomSheet;
