...
const AddOtherBottomSheet = ({ isOpen, handleClose }) => {
        ...
        <form onSubmit={onSubmit}>
          <div className={classes.content}>
            <div className={classes.inputContainer}>
              <label htmlFor="other-name" className={classes.label}>
                Description
              </label>
              <input
                id="other-name"
            ...
            <div className={classes.inputContainer}>
              <label htmlFor="other-footprint" className={classes.label}>
                Footprint
              </label>
              <input
                id="other-footprint"
...
export default AddOtherBottomSheet;
