...
const AddGoalBottomSheet = ({ isOpen, handleClose }) => {
  ...
  const onSubmit = (e) => {
    ...
    dispatch(addGoal({ name: name.trim() }));
    handleClose();
    ...
    <div
      ...
      <div className={`${classes.bottomSheet} ${isOpen ? "open" : ""}`}>
        ...
        <div className={classes.header}>
          <h2 className={classes.title}>Add Goal</h2>
        ...
        <form onSubmit={onSubmit}>
          <div className={classes.content}>
            <div className={classes.inputContainer}>
              <label htmlFor="goal-name" className={classes.label}>
                Goal Description
              </label>
              <input
                id="goal-name"
...
export default AddGoalBottomSheet;
