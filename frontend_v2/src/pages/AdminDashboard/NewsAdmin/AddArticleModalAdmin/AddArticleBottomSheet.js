...
const AddArticleBottomSheet = ({ isOpen, handleClose }) => {
  ...
  const onSubmit = (e) => {
    ...
    dispatch(addArticle({ title: name.trim(), image: image.trim(), text: description.trim() }));
    handleClose();
        ...
        <form onSubmit={onSubmit}>
          <div className={classes.content}>
            <div className={classes.inputContainer}>
              <label htmlFor="article-title" className={classes.label}>
                Title
              </label>
              <input
                id="article-title"
            ...
            <div className={classes.inputContainer}>
              <label htmlFor="article-image" className={classes.label}>
                Image URL
              </label>
              <input
                id="article-image"
            ...
            <div className={classes.inputContainer}>
              <label htmlFor="article-description" className={classes.label}>
                Article Content
              </label>
              <textarea
          ...
          <div className={classes.footer}>
            ...
            <button
              ...
              disabled={!values.name.trim() || !values.description.trim() || !values.image.trim()}>
              Save Changes
            </button>
          </div>
        </form>
...
export default AddArticleBottomSheet;
